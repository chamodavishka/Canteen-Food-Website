...
?>
        <div class="container">
            ...
            <form action="" method="post" autocomplete="off">
                ...
                <div class="row" style="margin-left:2%;">
                    ...
                    <div class="row">
                        <div class="col-28">
                            ...
                            <div class="col-29">
                                <div style="border:2px solid #ddd;border-radius: 4px; padding:5px; height: 76px; overflow: hidden;" id="req"><?=$requests; ?></div>
                            </div> 
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="margin-left:2%;">
                    <div class="col-32">
                    <button type="button" class="cartbtn1" name="removeCartItem" onclick="remove(<?=$value['foodId']; ?>)">Remove</button>
                    </div>
                </div>
