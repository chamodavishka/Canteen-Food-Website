<?php
  ...
  $sql = "SELECT * FROM deleted_user ORDER BY customer_id DESC";
    ...
    <div class="content"><br><br>
        ...
        <div class="container">
          ...
          <div class="tab">
            ...
            <button class="tablinks" onclick="openSuspendedUser()">Suspended Accounts</button>
            <button style="background-color:#ccc;" class="tablinks" onclick="openDeletedUser()">Deleted Accounts</button>
          </div>
          ...
          <div class="usersSus">
            ...
            ?>
                ...
                <button class="accordion" id="<?=$searchRow["customer_id"]; ?>">
                ...
                <div class="panel">
                  ...
                  <table class="tableUserDetails">
                    <tr>
                      ...
                      <td>SuspDate: <span class="spanRecode"><?php echo $searchRow["del_date"]; ?></span></td>
                    </tr>

                    <tr>
                      <td><image style="border-radius: 50px;" class="zoomUserSusp2" src="../../signup_form/profilePic/<?php echo $searchRow["profile_pic"]; ?>" width="40px" height="40px"></td>
                      <td colspan="2">Reason to Delete: <span class="spanRecode"><?php echo $searchRow["reason"]; ?></span></td>
                    </tr>
                  </table>
