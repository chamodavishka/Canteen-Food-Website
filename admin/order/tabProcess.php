<?php
  ...
  $sql = "SELECT * FROM orders WHERE order_status = 'Processing' ORDER BY order_id DESC";
    ...
    <div class="content"><br><br>
        ...
        <div class="container">
          ...
          <div class="tab">
            ...
            <button style="background-color:#ccc;" class="tablinks" onclick="openProcessing()">Processing</button>
          ...
          <div class="usersSus">
                  ...
                  <?php
                    ...
                    <tr>
                      <td style="background-color:white;" colspan="4">                  
                        <span class="cancelOrderSpan2" onclick="reaOrder(<?php echo $OID; ?>)">Mark as Ready</span>
                      </td>
                    </tr>
            ...
            ?>
              <h3 class="header3">In the present moment, there are no orders in the processing stage available for display.</h3>
              <br><br><br>
            <?php
              }
            ?>
    ...
    <div id="id05" class="modal3">
      ...
      <form class="modal3-content3 animate3" action="newOrderActions.php" method="post">
          ...
          <div class="containerReq">
              ...
              <button type="submit" class="sbbtn2" name="reaOrderP">Confirm</button>
          </div>
      </form>
    </div>
