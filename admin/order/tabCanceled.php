<?php
  ...
  $sql = "SELECT * FROM orders WHERE order_status = 'Cancelled' OR order_status = 'Canceled by the Canteen' ORDER BY order_id DESC LIMIT 100";
    ...
    <div class="content"><br><br>
        ...
        <div class="container">
          ...
          <div class="tab">
            ...
            <button style="background-color:#ccc;" class="tablinks" onclick="openCanceled()">Canceled</button>
          </div>
          ...
          <div class="usersSus">
            ...
            ?>
                ...
                <button class="accordion">
                  ...
                  <?php if($searchRow["order_status"] == 'Canceled by the Canteen') {echo " - "; echo $searchRow["order_status"];} ?>
                </button>
                <div class="panel">
            ...
            ?>
              <h3 class="header3">In the present moment, there are no orders in the Cancelled stage available for display.</h3>
              <br><br><br>
            <?php
              }
            ?>
